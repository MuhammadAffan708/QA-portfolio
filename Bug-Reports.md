...
After entering a valid email address, the application displays "OTP has been sent to your mail", but the OTP email is not received.
...
6. Check Inbox and Spam/Junk folders.
...
Reproduced multiple times, including with different email addresses.
